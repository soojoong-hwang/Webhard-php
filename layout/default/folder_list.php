<table class='toolbar' cellspacing='0' cellpadding='0' width='50%' align='center'>
	...
	<tr height='30'>
		...
		<td background='layout/<?=$hard_data[skin]?>/images/sidebar/titlebg.png' align='center' valign='middle'><b><?=$lang[menu_folder_select]?></b></td>
	...
	<tr>
		...
		<td valign='middle' align='center'><br><br>
			...
			<table>
			<tr><td align="right"><? $folder_list=folder_list(); ?><br /></td></tr>
			</table>
		</td>
